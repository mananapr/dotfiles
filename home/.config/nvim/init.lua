...
-- New splits to be opened on right and below
...
-- Preview substitutions live in a new split
...
-- Set highlight on search and clear on pressing <Esc> in normal mode
...
require('lazy').setup({
  ...
  'isobit/vim-caddyfile', -- Caddyfile syntax highlight
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Ensure servers mentioned above are installed
      require('mason').setup()
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            ...
            -- Override values passed in the server configuration above
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Set cursor location to LINE:COLUMN in the statusline
