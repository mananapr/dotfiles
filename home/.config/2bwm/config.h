...
///--Menus and Programs---///
static const char *menucmd[]     = {"dmen",         NULL};
static const char *terminalcmd[] = {"st",           NULL};
static const char *scrot[]       = {"scr",          NULL};
static const char *briup[]       = {"bri", "inc",   NULL};
static const char *bridown[]     = {"bri", "dec",   NULL};
...
static key keys[] = {
    ...
    {  MOD2 ,             XK_q,          start,             {.com = qr}},
    {  MOD2 ,             XK_m,          start,             {.com = dmount}},
    ...
    {  MOD2 |SHIFT ,      XK_Up,                            start,             {.com = briup}},
    {  MOD2 |SHIFT ,      XK_Down,                          start,             {.com = bridown}},
